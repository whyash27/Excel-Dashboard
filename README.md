...
1. Download `Sales_Report.xlsm` from this repository.
2. Open it in Microsoft Excel (macros/VBA content — enable editing & content when prompted).
3. Go to the **DASHBOARD** sheet.
4. Click any state in the Region slicer to filter all four dashboards at once.
5. Use the checkboxes above each dashboard to show/hide individual sections.
